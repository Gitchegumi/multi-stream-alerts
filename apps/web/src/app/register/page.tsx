  ...
  return (
    <main className="auth-shell">
      <section className="auth-card">
        ...
        <p className="muted">
          Registration requires a valid invite code from an administrator. Once you enter it, you
          will be redirected to your identity provider; on your first sign-in we provision a
          personal workspace for you.
        </p>
        {existingCode.ok ? <SignInForm callbackUrl="/dashboard" /> : <RegisterForm />}
