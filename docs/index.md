...
GitchAlerts is a self-hosted alert and canvas system for creators who want stream alerts, browser sources, event routing, assets, and credentials under their own control.
...
- [Overlays and canvases](developer-guide/overlays-and-canvases.md)
